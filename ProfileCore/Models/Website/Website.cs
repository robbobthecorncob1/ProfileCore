...
namespace ProfileCore.Models.website;
...
/// <summary>
/// Represents a single skill. Has variables holding all jobs, projects, and courses where the skill is used.
/// </summary>
...
public class Skill(string name)
{
    ...
    public List<Course> CoursesSkillUsed {get; set;} = [];
}
